...
public class UserNotificationController {
    ...
    @GetMapping("/users/{userId}/notifications") //exibe todas as notificações com o status CREATED apartir do id do usuario da tabela de notification
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable(value="userId") UUID userId,
        ...
        notificationModelOptional.get().setNotificationStatus(notificationDto.getNotificationStatus()); //modifico o status
